...
describe("これまで学んだすべて", function() {
  ...
  it("ナッツにアレルギーがあり、マッシュルームが嫌いな私が食べられるピザを見つけ出すこと (命令型)", function () {
  ...
  it("1000以内の自然数の内3と5の公倍数になる数字をすべて加算する (命令型)", function () {
  ...
  /*********************************************************************************/
   it("ピザのトッピング(ingredient)の回数を数える (命令型)", function () {
  ...
  it("ピザのトッピング(ingredient)の回数を数える (関数型)", function () {
    var ingredientCount = { "{ingredient name}": 0 };
