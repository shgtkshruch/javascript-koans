describe("配列", function() {
  ...
  it("配列の生成", function() {
    var emptyArray = [];
    expect(typeof(emptyArray)).toBe(FILL_ME_IN); //誤り? - http:javascript.crockford.com/remedial.html
